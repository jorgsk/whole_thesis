...
%\part{Regulation of transcription and translation initiation in the 5\protect\p
%untranslated region}
...
%% Infa2b expression
%\chapter{Project with Veronika -- bioinformatic approach to achieve expression
...
%% Polyadenylation
%\part{Using RNA-seq for indentification of sites of RNA cleavage and
%polyadenylation}
...
%\section{Landscape of Transcription in Human Cells}
%\includepdf[pages={-}]{../my_papers/encode/encode_14.pdf}

%\section{5\protect\p fusion partners for heterologous expression in
%\textit{E. coli}}
